...
fun DeckBuilderView() {
    ...
    val deckButtons = listOf(
        DeckButtonItem("Rebels Command Deck", R.drawable.rebel_logo),
        DeckButtonItem("Republic Command Deck", R.drawable.republic_logo),
        DeckButtonItem("CIS Command Deck", R.drawable.cis_logo),
        DeckButtonItem("Empire Command Deck", R.drawable.empire_logo)
    )
